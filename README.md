...
- [`after/queries/ecma/textobjects.scm`](./after/queries/ecma/textobjects.scm): query custom Treesitter per textobject su proprieta' JS/TS
...
- LSP installati da Mason: `html`, `cssls`, `svelte`, `lua_ls`, `graphql`, `emmet_ls`, `prismals`, `pyright`, `gopls`, `jdtls`, `clangd`, `texlab`
